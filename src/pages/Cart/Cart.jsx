...
function Cart() {
  ...
  if (cartItems.length === 0) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-slate-900 to-indigo-950 flex items-center justify-center px-4 py-12">
        <div className="text-center max-w-md">
          <div className="mb-6 inline-block p-6 bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-white/10 rounded-full">
          ...
          <p className="text-lg text-slate-400 mb-8">Your cart is empty</p>
          <Link 
            to="/#shop" 
            className="inline-block px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl font-semibold hover:-translate-y-1 transition-all shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40"
          >
            Continue Shopping
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 sticky top-24">
              ...
              <Link to="/checkout" className="block w-full py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl font-semibold hover:-translate-y-1 transition-all shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 text-center">
                Proceed to Checkout
              </Link>
            </div>
          </div>

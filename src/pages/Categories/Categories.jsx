          ...
          {categories.map((category, index) => {
            ...
            return (
              <button
                ...
                className="group relative bg-gradient-to-br from-slate-800/90 to-slate-900/90 backdrop-blur-xl border-2 border-slate-700/50 rounded-3xl p-5 lg:p-6 hover:border-blue-400/60 hover:scale-105 transition-all duration-300 overflow-hidden text-left"
              >
                {/* Gradient overlay */}
                ...
                <div className="relative z-10">
                  ...
                  <div className={`w-14 h-14 lg:w-16 lg:h-16 flex items-center justify-center bg-gradient-to-br ${category.color} rounded-2xl mb-3 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg`}>
                    <Icon className="text-2xl lg:text-3xl text-white" />
                  </div>

                  {/* Category Info */}
                  <h3 className="text-base lg:text-xl font-bold text-white mb-1 lg:mb-2 group-hover:text-blue-200 transition-colors">
                    {category.name}
                  </h3>
                  <p className="text-xs lg:text-sm text-slate-400 mb-3">
                    {category.desc}
                  </p>

                  {/* Arrow indicator */}
                  <div className="flex items-center gap-1 text-blue-400 opacity-0 group-hover:opacity-100 transition-opacity">
                    <span className="text-xs lg:text-sm font-semibold">Shop Now</span>

...
function CategoryGoogle() {
  const products = [
    ...
    },
    {
      ...
      price: 499,
      storage: '128GB',
      image: 'https://images.unsplash.com/photo-1598327105666-5b1730a3d066?w=400&h=400&fit=crop&q=90',
    }
  ]
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            Pixel series phones with pure Android experience
          </p>
        </div>
